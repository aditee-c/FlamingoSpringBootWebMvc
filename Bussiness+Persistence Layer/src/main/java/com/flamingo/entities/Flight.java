...
//	@GeneratedValue(strategy = GenerationType.AUTO)
	...
	@OneToMany(mappedBy = "flight",fetch = FetchType.EAGER)//updated by aditee
	@JsonIgnore
	...
	public Flight(int flightId, String flightName, String fromLocation, String toLocation, LocalDate departureDate,
			LocalDate arrivalDate, LocalTime departureTime, LocalTime arrivalTime, String duration, int totalSeats) {
		super();
